...
# {:ok, %Dynamo.ReadResult{cursor_id: 0, docs: [%{"code" => 16436, "errmsg" => "exception: Unrecognized pipeline stage name: '$projection'", "ok" => 0.0}], from: 0, num: 1}}

defmodule Dynamo.Cursor do
  @moduledoc false
...
defmodule Dynamo.AggregationCursor do
  @moduledoc false
...
defmodule Dynamo.SinglyCursor do
  @moduledoc false
