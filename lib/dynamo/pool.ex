defmodule Dynamo.Pool do
  @moduledoc """
  Defines a pool of DynamoDB connections.

  A pool can be defined as:

      defmodule MyPool do
        use Dynamo.Pool,
          adapter: Dynamo.Pool.Poolboy,
          hostname: "localhost"
       end

  Options will be passed to the pool adapter and to `Dynamo.Connection`.
  ...
  @doc """
  Returns the version of the DynamoDB wire protocol used for the pool's connections
  """
